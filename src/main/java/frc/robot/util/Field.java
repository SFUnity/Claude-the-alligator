...
public class Field {
  ...
  public static class LeftBlueBump {
    public static final Translation2d nearLeftCorner =
        new Translation2d(
            BlueHub.centerX - BlueBumps.depth / 2.0, fieldWidth - BlueTrench.openingWidth);
  ...
  public static class LeftBlueTrench {
    ...
    public static final Translation3d openingTopRight =
        new Translation3d(
            BlueHub.centerX, fieldWidth - BlueTrench.openingWidth, BlueTrench.openingHeight);
  }

  public static class RightBlueTrench {
    public static final Translation3d openingTopLeft =
        new Translation3d(BlueHub.centerX, BlueTrench.openingWidth, BlueTrench.openingHeight);
