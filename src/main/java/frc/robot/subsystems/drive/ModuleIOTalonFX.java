...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    driveConfig.CurrentLimits.StatorCurrentLimit = 70.0;
    ...
    turnConfig.Slot0.StaticFeedforwardSign = StaticFeedforwardSignValue.UseClosedLoopSign;
    ...
    turnConfig.MotorOutput.Inverted =
        constants.SteerMotorInverted
            ? InvertedValue.Clockwise_Positive
            : InvertedValue.CounterClockwise_Positive;
    turnConfig.CurrentLimits.StatorCurrentLimit = 70.0;
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    var turnStatus =
        BaseStatusSignal.refreshAll(turnPosition, turnVelocity, turnAppliedVolts, turnStatorCurrent, turnSupplyCurrent);
