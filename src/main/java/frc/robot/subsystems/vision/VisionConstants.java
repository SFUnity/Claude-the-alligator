...
public class VisionConstants {
  ...
  public static final LimelightConfigs starboardFore =
      new LimelightConfigs("limelight-sfore", 0, 0, 0, 0, 0, 0);
  public static final LimelightConfigs starboardAft =
      new LimelightConfigs("limelight-saft", -0.308, 0.256, 0.202111, 0, 24.45, 207.785);
  public static final LimelightConfigs portFore =
      new LimelightConfigs("limelight-pfore", -0.247, -0.286, 0.228, 0, 24.5, 45);
