...
public class Module {
  ...
  public void periodic() {
    ...
    Logger.recordOutput(
        "Odometry/WrappedModuleAngles/Measured" + index, Math.abs(getAngle().getDegrees() % 360));
  ...
  public void runSetpoint(SwerveModuleState state) {
    ...
    // Log
    Logger.recordOutput(
        "Odometry/WrappedModuleAngles/Setpoints" + index, Math.abs(state.angle.getDegrees() % 360));
  }
