...
public class ShooterConstants {
    ...
    public static final LoggedTunableNumber autoTrenchDistance = new LoggedTunableNumber("SmartDashboard/TunableNumbers/Shooter/AutoTrenchDistance", 3);
    public static final LoggedTunableNumber autoHoodAngle = new LoggedTunableNumber("SmartDashboard/TunableNumbers/Shooter/AutoHoodAngle", 28);
    public static final LoggedTunableNumber autoFlywheelVelocity = new LoggedTunableNumber("SmartDashboard/TunableNumbers/Shooter/AutoFlywheelVelocity", 1200);
}
